...
export const CheckBoxOutlineIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    width="20"
    height="20"
...
export const CheckBoxFilledIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    width="20"
    height="20"
...
export const PackageIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      d="M20 8L12 3L4 8V16L12 21L20 16V8Z"
      stroke="currentColor"
      strokeWidth="1.6"
      strokeLinecap="round"

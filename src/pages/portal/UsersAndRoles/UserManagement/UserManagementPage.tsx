...
export default function UserManagementPage() {
  ...
  const actions = {
    ...
    // Hàm xử lý nút bulk action
    bulk: (action: BulkAction) => {
      if (!users.some((u) => u.selected)) {
        // new: Thay thế alert bằng toast cảnh báo
      ...
      // thông báo thành công khi bulk Activate/Deactivate
      toast.success(
    ...
    // Kiểm tra trạng thái/role trước khi cho phép chỉnh sửa
  ...
  const executeDelete = () => {
    if (deleteConfig.type === "single" && deleteConfig.userId !== null) {
      ...
      // thông báo thành công cho xóa đơn
      ...
      // thông báo thành công cho xóa hàng loạt
